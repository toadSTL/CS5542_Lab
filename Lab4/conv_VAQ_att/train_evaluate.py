...
def main():
    ...
    parser.add_argument('--sample_every', type=int, default=33,
                       help='Debug every x iterations')
    parser.add_argument('--evaluate_every', type=int, default=99,
    ...
    for epoch in range(args.epochs):
        ...
        while (batch_no*args.batch_size) < len(qa_data['training']):
            ...
            if step % args.sample_every == 0:
                ...
                f = open('Data/samples/sample.json', 'w', encoding="utf8")
            ...
            if step % args.evaluate_every == 0:
                ...
                f = open(args.training_log_file, 'w', encoding="utf8")
