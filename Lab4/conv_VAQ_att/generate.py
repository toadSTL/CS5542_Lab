...
def main():
    ...
    parser.add_argument('--model_path', type=str, default="Data/Models1/model199.ckpt",
    ...
    parser.add_argument('--text_model', type=str, default="bytenet",
                       help='bytenet/lstm')
    parser.add_argument('--question', type=str, default="What color is the cat?",
                       help='question about the image')
    parser.add_argument('--image_file', type=str, default="Data/train2014/COCO_train2014_000000193386.jpg",
                       help='Image File path')

    # EXAMPLE PAIRS
    #
    # "What color is the cat?"
    # "Data/train2014/COCO_train2014_000000193386.jpg"
    # black and white or black white
    #
    # "What is the round object?"
    # "Data/train2014/COCO_train2014_000000387102.jpg"
    # cake
    #
    # "How many metal rods are holding this umbrella?"
    # "Data/train2014/COCO_train2014_000000575249.jpg"
    # 8 or 12 or 16
    ...
    for sample_i in range(len(pred_ans_text)):
        ...
        f = open('Data/gen_samples/sample.json', 'w', encoding="utf8")
